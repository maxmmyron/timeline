...
export const exportVideo = async () => {
  ...
  await ffmpegInstance.run("-t", duration.toString(), "-f", "lavfi", "-i", `color=c=green:s=${dims[0]}x${dims[1]}:r=30`, "-f", "lavfi", "-i", "anullsrc=channel_layout=stereo:sample_rate=44100", "-pix_fmt", "yuv420p", "-shortest", "base.mp4");
